...
Parameters:
  ...
  Mode options: luminance | rgb | rand (randomly pick per variant)
	...
	parser.add_argument('--count', type=int, required=True, help='Number of augmentation variants to generate')
	...
	# Handle samples (quality preset or explicit range/value)
